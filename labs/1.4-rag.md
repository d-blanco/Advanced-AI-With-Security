...
2. Find the **Azure AI Search** resource and click on it.
...
3. Configure the following settings to point to your data:
   ...
   - **Folder:** select the `reviews` folder as shown in the image below
   - **Header row:** ✅ Check this box — our CSV files have headers

![Reviews RAG Configuration](ai-security-images/createreviews-rag.png)
