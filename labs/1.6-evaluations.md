...
Try running the evaluation without any strict instructions, then add the instructions below and run the evaluation again. Compare the results. **Make sure to only use the Similarity Criteria**
```
